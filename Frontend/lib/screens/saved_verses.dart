...
//       verseProvider.fetchSavedVerses(reset: true);
//     });
//   }
//
//   @override
...
//         },
//         child: verseProvider.savedVerses.isEmpty && !verseProvider.isLoading
//             ? const Center(child: Text('No saved verses'))
//             : ListView.builder(
//           controller: _scrollController,
//           itemCount: verseProvider.savedVerses.length + 1,
//           itemBuilder: (context, index) {
//             if (index == verseProvider.savedVerses.length) {
//               // Show a loading indicator at the bottom
//               return verseProvider.isLoading
